...
export const FFButton = ({
    ...
    return (
        <button
            className={cn(
                'flex items-center justify-center rounded-full font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-accent-1 focus:ring-offset-2',
                // Primary
                ...
                // Sizing
                'h-[45px] px-6 text-sm lg:text-base w-full',
                className
            )}
            disabled={isDisabled}
            {...props}
