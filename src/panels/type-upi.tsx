...
/**
 * TypeUpi — full UPI ID entry panel.
 *
 ...
 * ─────────────────────────────────────────────────────────────────
 *
 * Integration hook: replace handleContinue with a call to
 *   isValidUpi(upiId) then fetchLnAddress(upiId) from lib/payments.ts.
 */
const TypeUpi = () => {
    ...
    return (
        ...
        >
            ...
            <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
                ...
                {/* Title — responsive font size via .tupi-title class */}
                <span
            ...
            {/* divide:160 — gap between header and content */}
                ...
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 120 }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 24, alignItems: 'center' }}>
                            ...
                            {/* Instruction text — 297px container, centered */}
                            ...
                            {/* Input + Paste sub-column — divide:12, max-width 537px desktop */}
                            <div className='tupi-input-group' style={{ display: 'flex', flexDirection: 'column', gap: 12, width: '100%' }}>

                                {/* UPI ID input — coolGray200 border, transparent-on-focus substituted with black */}
                                <input
                                    type='text'
                                    value={upiId}
                                ...
                                <div style={{ display: 'flex', justifyContent: 'center' }}>
                                    ...
                                    >
                                        <span className='material-symbols-rounded' style={{ fontSize: 24, color: '#000000', fontVariationSettings: "'FILL' 0" }}>content_paste</span>
                                        <span style={{ fontFamily: FF_FONT, fontSize: 16, fontWeight: 500, color: '#000000', lineHeight: 1.5, letterSpacing: 0 }}>Paste</span>
                                    </button>
                                </div>

                                {/* Scan QR Instead — ghost button */}
                                <div style={{ display: 'flex', justifyContent: 'center' }}>
                                    <button
                                    ...
                                    >
                                        <span className='material-symbols-rounded' style={{ fontSize: 24, color: '#626D7C', fontVariationSettings: "'FILL' 0" }}>qr_code_scanner</span>
                                        <span style={{ fontFamily: FF_FONT, fontSize: 16, fontWeight: 500, color: '#626D7C', lineHeight: 1.5, letterSpacing: 0 }}>Scan QR Instead</span>
                                    </button>
                                </div>
                            </div>
                        </div>

                        {/* Continue button — full width mobile / 343px desktop */}
                        <div style={{ display: 'flex', justifyContent: 'center' }}>
                            <button
                            ...
                            >
                                <span style={{ fontFamily: FF_FONT, fontSize: 14, fontWeight: 500, color: '#FFFFFF', lineHeight: 1.5, letterSpacing: 0 }}>Continue</span>
                            </button>
                        </div>
                    </div>
                </div>
